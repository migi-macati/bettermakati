    ...
    <>
      <div className="bg-primary-900 text-white">
        <div className="container px-4 min-h-9 flex items-center justify-between gap-4 text-xs">
          <div className="flex items-center gap-3 overflow-x-auto whitespace-nowrap py-2">
            ...
            <a href="tel:+63288701000" className="hover:text-secondary-200">
              City Hall: 8870-1000
            </a>
            <span className="text-primary-200">•</span>
            <Link
              to="/hotlines"
              className="text-white underline underline-offset-2 hover:text-secondary-200"
            >
              More hotlines
            </Link>
          </div>
      ...
      <nav className="bg-[#fffdf8]/95 backdrop-blur-md border-b border-[#eadfca] sticky top-0 z-50">
        <div className="container px-4">
          <div className="flex justify-between items-center py-3.5 gap-5">
            <BrandMark />
            ...
            <button
              ...
              className="xl:hidden inline-flex items-center justify-center p-2 rounded-lg text-gray-700 hover:bg-primary-50"
        ...
        <div
          ...
          className={`xl:hidden ${isOpen ? 'block' : 'hidden'} border-t border-[#eadfca] bg-[#fffdf8]`}
        >
          <div className="container px-2 py-3 space-y-1 max-h-[75vh] overflow-y-auto">
            {mainNavigation.map(item => (
              <div key={item.label}>
                {item.children ? (
                  <>
