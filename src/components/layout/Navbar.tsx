  ...
  return (
    <>
      ...
      <nav className="bg-[#fffdf8]/95 backdrop-blur-md border-b border-[#eadfca] sticky top-0 z-50">
            ...
            <div className="hidden xl:flex items-center gap-4">
              {mainNavigation.map(item => (
                <div key={item.label} className="relative group">
                  <Link
                    to={item.href}
                    className="flex items-center text-[14px] text-gray-700 hover:text-primary-700 font-semibold transition-colors whitespace-nowrap"
                  >
                    {item.label}
        ...
        <div className={`xl:hidden ${isOpen ? 'block' : 'hidden'} border-t border-[#eadfca] bg-[#fffdf8]`}>
