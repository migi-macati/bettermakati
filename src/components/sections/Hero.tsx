  ...
  return (
    <section className="makati-hero overflow-visible">
      <div className="container px-5 md:px-6 lg:px-8 py-10 md:py-14 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-10 items-center">
          <div className="animate-fade-in">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-gray-600">
              Services, offices, barangays, public records, places and civic
              tools in one independent city guide.
            </p>
