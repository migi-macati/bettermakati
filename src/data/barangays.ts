...
const barangayContactSupplement: Record<string, Partial<BarangayProfile>> = {
  ...
  'san-antonio': {
    ...
    hallPhone: "(02) 8896-4265 / (02) 8890-4366",
    hallEmail: "makatisanantonio@yahoo.com",
    hallSource: "https://notices.philgeps.gov.ph/GEPSNONPILOT/Tender/SplashBidNoticeAbstractUI.aspx?BusCatID=123&DirectFrom=OpenOpp&Type=category&menuIndex=3&refID=13173396",
    hallSourceLabel: "PhilGEPS barangay procurement contact · Aug. 2026",
  },
  'san-isidro': {
    hallAddress: "2701 Guatemala Street, San Isidro, Makati City",
    hallPhone: "(02) 8845-0260",
    hallEmail: "sanisidromkt@gmail.com",
    hallSource: "https://notices.philgeps.gov.ph/GEPSNONPILOT/Tender/PrintableBidNoticeAbstractUI.aspx?refid=11467715",
    hallSourceLabel: "PhilGEPS barangay procurement contact",
  },
  'santa-cruz': {
  ...
  'tejeros': {
    ...
    hallEmail: "barangay_tejeros@yahoo.com.ph",
    hallSource: "https://notices.philgeps.gov.ph/GEPSNONPILOT/Tender/PrintableBidNoticeAbstractUI.aspx?refid=11452579",
    hallSourceLabel: "PhilGEPS barangay procurement contact",
  },
  'urdaneta': {
...
const barangayBaseProfiles: BarangayProfile[] = [
  ...
  { slug: 'bel-air', name: 'Bel-Air', population2024: 39354, legislativeDistrict: '1st District', officialPageUrl: 'https://www.makati.gov.ph/barangay/bel--air/30', websiteUrl: 'https://barangaybelair.ph/', hallEmail: 'belair_admin@barangaybelair.ph', publishedServices: [
    ...
    },
    {
      ...
      type: 'Certificate',
      summary: 'Barangay-issued Community Tax Certificate.',
      requirements: ['Government-issued ID', 'Proof of residency', 'Supporting income document such as ITR when applicable'],
      availability: 'Same-day issuance when requirements and payment are complete',
      sourceUrl: 'https://barangaybelair.ph/cedula/',
      sourceLabel: 'Barangay Bel-Air · Cedula',
    },
  ...
  { slug: 'pio-del-pilar', name: 'Pio Del Pilar', population2024: 55572, legislativeDistrict: '1st District', officialPageUrl: 'https://www.makati.gov.ph/barangay/pio-del-pilar/33', websiteUrl: 'https://brgypiodelpilarmakati.com.ph/staging/', hallEmail: 'bpiodelpilarsecoffice2020@gmail.com', publishedServices: [
    {
      ...
      type: 'Other',
      summary: 'The official Barangay Pio Del Pilar site provides a dedicated services page and hall contact channel.',
      sourceUrl: 'https://brgypiodelpilarmakati.com.ph/staging/services',
      sourceLabel: 'Barangay Pio Del Pilar · Services',
    },
  ], officials: { punongBarangay: 'Hazel Ann S. Lacia', source: 'https://www.makati.gov.ph/barangay/pio-del-pilar/33' } },
  { slug: 'poblacion', name: 'Poblacion', population2024: 17088, legislativeDistrict: '1st District', officialPageUrl: 'https://www.makati.gov.ph/barangay/poblacion/34?tab=682', websiteUrl: 'https://epoblacion.net/', publishedServices: [
    { title: 'Barangay certificate', type: 'Certificate', summary: 'Online barangay-certificate request through the E-Poblacion portal.', sourceUrl: 'https://epoblacion.net/', sourceLabel: 'E-Poblacion automated services' },
    { title: 'Barangay ID', type: 'ID', summary: 'Online barangay ID application through the E-Poblacion portal.', sourceUrl: 'https://epoblacion.net/', sourceLabel: 'E-Poblacion automated services' },
    { title: 'Business clearance', type: 'Clearance', summary: 'Online business-clearance application through the E-Poblacion portal.', sourceUrl: 'https://epoblacion.net/', sourceLabel: 'E-Poblacion automated services' },
    { title: 'Certificate of indigency', type: 'Certificate', summary: 'Online indigency-certificate request through the E-Poblacion portal.', sourceUrl: 'https://epoblacion.net/', sourceLabel: 'E-Poblacion automated services' },
    { title: 'First-time jobseeker certification', type: 'Certificate', summary: 'Online first-time jobseeker request through the E-Poblacion portal.', sourceUrl: 'https://epoblacion.net/', sourceLabel: 'E-Poblacion automated services' },
    { title: 'Birth and death reporting', type: 'Other', summary: 'The E-Poblacion portal includes report-of-birth and report-of-death workflows.', sourceUrl: 'https://epoblacion.net/', sourceLabel: 'E-Poblacion automated services' },
  ], officials: { punongBarangay: 'Jose Mikhail R. Villena', source: 'https://www.makati.gov.ph/barangay/poblacion/34?tab=682' }, heritageMarkers: [{ name: 'Makati', agency: 'NHCP', status: 'Level II – Historical marker', href: 'https://philhistoricsites.nhcp.gov.ph/registry_database/makati/', location: 'Old Makati City Hall Building, J.P. Rizal Avenue cor. Angono Street' }, { name: 'San Pedro Macati', agency: 'NHCP', status: 'Level II – Historical marker', href: 'https://philhistoricsites.nhcp.gov.ph/registry_database/san-pedro-macati/', location: 'Saints Peter and Paul Church' }, { name: 'Museo ng Makati', agency: 'NCCA', status: 'Important Cultural Property / registered property', href: 'https://talapamana.ncca.gov.ph/index.php/component/content/article/talapamana-metro-manila?Itemid=101&catid=12', location: 'Makati, Metro Manila' }], hallAddress: 'J.P. Rizal cor. D.M. Rivera Street, Makati City', hallPhone: '(02) 8808-8087 / (02) 8681-4034', hallEmail: 'barangaypobmak@gmail.com', hallSource: 'https://epoblacion.net/home/about', hallSourceLabel: 'Barangay Poblacion website', associations: [{ name: 'Century City', href: 'https://www.centurycitymall.com.ph/', linkLabel: 'Estate / mall website' }, { name: 'Rockwell Center', href: 'https://e-rockwell.com/', linkLabel: 'Estate website' }, { name: 'Makati Central Estate Association (MACEA)', href: 'https://macea.com.ph/', linkLabel: 'Estate association' }], notablePlaces: [{ name: 'Museo ng Makati', href: 'https://www.google.com/maps/search/?api=1&query=Museo+ng+Makati', type: 'Institution' }, { name: 'Saints Peter and Paul Parish', href: 'https://www.google.com/maps/search/?api=1&query=Saints+Peter+and+Paul+Parish+Makati', type: 'Heritage' }] },
...
export const barangayCoverageSummary = {
  ...
  verifiedOfficialWebsites: barangays.filter(item => Boolean(item.websiteUrl)).length,
