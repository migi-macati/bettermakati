...
const barangayBaseProfiles: BarangayProfile[] = [
  ...
  { slug: 'bel-air', name: 'Bel-Air', population2024: 39354, legislativeDistrict: '1st District', officialPageUrl: 'https://www.makati.gov.ph/barangay/bel--air/30', heritageMarkers: [{ name: 'Nielson Tower', agency: 'NHCP', status: 'Level II – Historical marker', href: 'https://philhistoricsites.nhcp.gov.ph/registry_database/nielson-tower/', location: 'Ayala Triangle Gardens, Makati Avenue cor. Ayala Avenue, Barangay Bel-Air' }], notablePlaces: [{ name: 'Nielson Tower / Blackbird', href: 'https://philhistoricsites.nhcp.gov.ph/registry_database/nielson-tower/', type: 'Heritage', source: 'NHCP / Makati Museum and Cultural Affairs Office' }], associations: [{ name: 'Bel-Air Village Association (BAVA)', href: 'https://www.bava.ph/', linkLabel: 'Website' }, { name: 'Makati Central Estate Association (MACEA)', href: 'https://macea.com.ph/', linkLabel: 'Estate association' }] },
