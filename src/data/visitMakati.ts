export interface VisitorPlace {
  name: string;
  category: 'Culture' | 'Food & Markets' | 'Parks' | 'Shopping & Lifestyle' | 'District';
  summary: string;
  mapsQuery: string;
  sourceUrl: string;
  sourceLabel: string;
...
export const visitorPlaces: VisitorPlace[] = [
  {
    ...
    sourceUrl: 'https://www.tourism.gov.ph/destination/national-capital-region/makati/',
...
export const heritageSites: HeritageSite[] = [
  {
    ...
    period: '1601–1629',
    summary: 'Augustinian church and monastery with foundations laid in 1601 and construction completed in 1629.',
  ...
  },
  {
    ...
    period: '1600s',
    summary: 'Historic San Pedro Macati church associated with the old town of San Pedro de Makati.',
  ...
  },
  {
    ...
    period: '1937',
    summary: 'Former passenger station and control center of Nielson Airport, used from 1937 to 1947.',
  ...
  },
  {
    ...
    period: '1918',
    summary: 'Makati cultural institution housed in a heritage structure in Poblacion.',
...
export const historyTimeline: HistoryEntry[] = [
  {
    year: '1578',
    title: 'San Pedro Makati appears as a visita',
    summary: 'The settlement then known as San Pedro Makati or Sampiro was a visita of Santa Ana de Sapa.',
    sourceUrl: 'https://philhistoricsites.nhcp.gov.ph/registry_database/makati/',
    sourceLabel: 'NHCP',
  },
  {
    year: '1608',
    title: 'Encomienda of Pedro de Brito',
    summary: 'Makati was granted as an encomienda to Captain Pedro de Brito.',
    sourceUrl: 'https://philhistoricsites.nhcp.gov.ph/registry_database/makati/',
    sourceLabel: 'NHCP',
  },
  {
    year: '1670',
    title: 'Makati becomes a town',
    summary: 'The NHCP historical marker records Makati as becoming a town in 1670.',
    sourceUrl: 'https://philhistoricsites.nhcp.gov.ph/registry_database/makati/',
    sourceLabel: 'NHCP',
  },
  {
    year: '1901',
    title: 'Part of the Province of Rizal',
    summary: 'San Pedro de Makati was incorporated into the Province of Rizal.',
    sourceUrl: 'https://philhistoricsites.nhcp.gov.ph/registry_database/makati/',
    sourceLabel: 'NHCP',
  },
  {
    year: '1914',
    title: 'The name becomes Makati',
    summary: 'Act No. 2390 changed the official name from San Pedro de Makati to Makati.',
    sourceUrl: 'https://www.makati.gov.ph/assets/uploads/downloads/2/49/241/pdf/I.%20History.pdf',
    sourceLabel: 'City of Makati',
  },
  {
    year: '1937',
    title: 'Nielson Airport era begins',
    summary: 'Nielson Tower was built and served the country’s first modern commercial international airport from 1937 to 1947.',
    sourceUrl: 'https://philhistoricsites.nhcp.gov.ph/registry_database/nielson-tower/',
    sourceLabel: 'NHCP',
  },
  {
    year: '1980s',
    title: 'Ayala Avenue becomes a major protest center',
    summary: 'Makati’s official history recounts the confetti rallies and major demonstrations held along Ayala during the late Marcos period.',
    sourceUrl: 'https://www.makati.gov.ph/assets/uploads/downloads/2/49/241/pdf/I.%20History.pdf',
    sourceLabel: 'City of Makati',
  },
  {
    year: '1995',
    title: 'Makati becomes a highly urbanized city',
    summary: 'Republic Act No. 7854 converted the municipality into the City of Makati; the city’s history records ratification in a February 1995 plebiscite.',
    sourceUrl: 'https://lawphil.net/statutes/repacts/ra1995/ra_7854_1995.html',
    sourceLabel: 'Lawphil',
  },
];
